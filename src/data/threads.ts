...
export const THREADS: Thread[] = [
  {
    ...
    preview: {
      type: "svg",
      svg_sanitized: `<svg viewBox="0 0 200 150" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#10b981" stroke-width="1">
  ...
  },
  {
    ...
    preview: {
      type: "svg",
      svg_sanitized: `<svg viewBox="0 0 200 150" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#10b981" stroke-width="1.5">
      <line x1="30" y1="20" x2="30" y2="130" />
      <line x1="170" y1="20" x2="170" y2="130" />
      <path d="M30,40 L170,65" />
      <path d="M170,80 L30,95" />
      <path d="M30,105 L170,120" />
      <text x="90" y="38" font-size="8" fill="#10b981" text-anchor="middle">SYN</text>
      <text x="90" y="78" font-size="8" fill="#10b981" text-anchor="middle">SYN-ACK</text>
  ...
  },
  {
    ...
    preview: {
      ...
      <circle cx="35" cy="75" r="6" fill="#10b981" fill-opacity="0.3" />
      <circle cx="70" cy="75" r="6" fill="#10b981" fill-opacity="0.3" />
      <circle cx="100" cy="75" r="6" fill="#10b981" fill-opacity="0.3" />
      <circle cx="140" cy="75" r="6" fill="#10b981" fill-opacity="0.3" />
      <circle cx="170" cy="75" r="6" fill="#10b981" fill-opacity="0.3" />
      <text x="30" y="100" font-size="7" fill="#10b981">joy</text>
  ...
  },
  {
    ...
    preview: {
      ...
      <path d="M55,67.5 L80,67.5" />
      <path d="M120,67.5 L145,67.5" />
      <path d="M165,80 Q165,120 100,120 Q35,120 35,80" stroke-dasharray="4,3" />
      <text x="25" y="71" font-size="6" fill="#10b981">Pending</text>
      <text x="85" y="71" font-size="6" fill="#10b981">Running</text>
